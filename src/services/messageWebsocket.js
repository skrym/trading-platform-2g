...
import { AUTO_CLOSE_ORDER_EVENT, AUTO_CLOSE_ORDER_EVENT_CLIENT, DOMAIN } from '../constants/server/constants';

const WEBSOCKET_URL = process.env.NODE_ENV === 'production' ? `wss://${DOMAIN}:5050` : 'ws://localhost:5050';
