...
const PAYMENTS_SYSTEM = [
    { id: 1, name: 'qiwi', icon: './images/qiwi.svg' },
    { id: 2, name: 'bitcoin', icon: './images/bit.svg' },
    { id: 3, name: 'visa', icon: './images/visa.svg' }
];
...
export default connect(mapStateToProps, mapDispatchToProps)(outsideClick(PaymentsPopup));
