...
import buyAndSellStyles from '../BuyAndSellComponent/BuyAndSellComponent.module.scss';
...
export default connect(mapStateToProps, mapDispatchToProps)(outsideClick(ConfirmPopup));
